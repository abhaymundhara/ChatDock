...
const edit_file = {
  name: 'edit_file',
  description: 'Applies surgical edits to specific lines of a file. Each edit specifies a line range and replacement content.',
  parameters: {
    type: 'object',
    properties: {
      path: {
      ...
      edits: {
        ...
        items: {
          ...
          properties: {
            ...
            content: { type: 'string', description: 'Replacement content for the specified lines' }
          },
...
const append_file = {
  ...
  parameters: {
    ...
    properties: {
      ...
      newline: {
        type: 'boolean',
        description: 'Add a newline before the content if file is not empty (default: true)',
        default: true
      }
    },
    required: ['path', 'content']
...
const delete_file = {
  name: 'delete_file',
  description: 'Deletes a file from the filesystem. This action cannot be undone.',
  parameters: {
    type: 'object',
    properties: {
      path: {
...
const create_directory = {
  ...
  description: 'Creates a new directory. Creates parent directories if they don\'t exist.',
  parameters: {
    type: 'object',
    properties: {
      path: {
